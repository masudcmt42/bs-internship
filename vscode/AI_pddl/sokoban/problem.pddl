(define (problem simple)
  ...
  (:objects left right up down - direction
  B1 B2 B3 B4 B5 B6 B7 - box
    
  		    c13 c14 c15 - location 
  c21 c22 c23 c24 c25 - location
  		    c33 c34 c35 
  c41 		    c44 c45 - location
  c51 c52	  c53 c54 c55 - location
  c61 c62 c63 c64 c65 c66 - location
  c71 c72 c73 c74 c75 c76 - location)
  ...
  (:init
     ...
     (adjacent c22 c21 left) (adjacent c22 c23 right)(clear c22) 
     ...
     (at-player c22)
     (=(total-cost) 0)
     (= (weight B1) 2)(= (weight B2) 3)(= (weight B3) 3)(= (weight B4) 5)(= (weight B5) 3)(= (weight B6) 3)(= (weight B7) 5)
